...
\newcommand{\PhysicsVersion}{1.1}
\newcommand{\TheoryVersion}{1.1}
\newcommand{\TheoryCompatibleCommit}{7251499}
\newcommand{\TheoryGenerationDate}{2026-06-26}
\newcommand{\TheoryPipelineVersion}{H3-W9b}
\newcommand{\TheoryImplementationStatus}{implemented through H3-W9b POWHEG real-smoke execution}
...
\vfill
{\large Implemented theory through H3-W9b POWHEG real-smoke execution\par}
\vspace{0.5cm}
...
H3-W9b POWHEG Real Smoke & implemented/smoke and documented \\
...
H3-W9b POWHEG Real Smoke & implemented/smoke & yes \\
...
\section{Real-smoke LHE validation}
...
mode one validated \code{pwgevents.lhe}.\\
