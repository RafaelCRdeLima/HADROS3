    ...
    *,
    ...
    return {
        ...
        "observer_bridge": {
            ...
            "pixel_map_width": observer_bridge_summary.get("pixel_map_width") if observer_bridge_active else None,
            "pixel_map_height": observer_bridge_summary.get("pixel_map_height") if observer_bridge_active else None,
            "pixel_coordinate_convention": observer_bridge_summary.get("pixel_coordinate_convention") if observer_bridge_active else "camera_preview_pixel_grid",
            ...
            "interactive_rays_resolution_source": observer_bridge_summary.get("interactive_rays_resolution_source") if observer_bridge_active else None,
            "interactive_rays_pixel_map_width": observer_bridge_summary.get("interactive_rays_pixel_map_width") if observer_bridge_active else None,
            "interactive_rays_pixel_map_height": observer_bridge_summary.get("interactive_rays_pixel_map_height") if observer_bridge_active else None,
            "interactive_rays_global_overlay_width": observer_bridge_summary.get("interactive_rays_global_overlay_width") if observer_bridge_active else None,
            "interactive_rays_global_overlay_height": observer_bridge_summary.get("interactive_rays_global_overlay_height") if observer_bridge_active else None,
            "interactive_rays_resolution_warning": observer_bridge_summary.get("interactive_rays_resolution_warning") if observer_bridge_active else None,
            "interactive_rays_resolution_matches_pixel_map": observer_bridge_summary.get("interactive_rays_resolution_matches_pixel_map") if observer_bridge_active else None,
        ...
        "observer_image_branches": {
            **(observer_image_branch_summary or {}),
            ...
            "gravitational_image_analysis_invoked": bool((observer_image_branch_summary or {}).get("gravitational_image_analysis_invoked", observer_image_branch_active)),
            "visual_stage_name": (observer_image_branch_summary or {}).get("visual_stage_name", "Gravitational Image Analysis" if observer_image_branch_active else None),
            "branch_scoring_model": (observer_image_branch_summary or {}).get("branch_scoring_model"),
            "branch_score_is_proxy": (observer_image_branch_summary or {}).get("branch_score_is_proxy", True if observer_image_branch_active else None),
            "branch_score_not_true_magnification": (observer_image_branch_summary or {}).get("branch_score_not_true_magnification", True if observer_image_branch_active else None),
            "branch_selection_model": (observer_image_branch_summary or {}).get("branch_selection_model"),
