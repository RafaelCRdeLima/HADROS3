    ...
    *,
    ...
    return {
        ...
        "powheg": {
            ...
            "powheg_candidate_source": powheg_summary.get("powheg_candidate_source") if powheg_active else "ObserverBridge/observer_bridge_selected_candidates.jsonl",
            "powheg_n_selected_candidates_input": powheg_summary.get("powheg_n_selected_candidates_input") if powheg_active else 0,
            "powheg_selection_performed_by": powheg_summary.get("powheg_selection_performed_by") if powheg_active else "ObserverBridge",
